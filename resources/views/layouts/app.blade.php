...
<head>
    ...
    <!-- prendo il file admin appena creato e lo porto sull'Html  -->
                ...
                <div class="sidebar-sticky">
                    <ul class="nav flex-column">
                        ...
                        <li class="nav-item">
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="20" viewBox="0 0 24 24"><path fill="#4599de" d="M24 10h-10v-10h-4v10h-10v4h10v10h4v-10h10z"/></svg>
                                Add post
                            </a>
                        </li>
                        <li class="nav-item">
